...
console.log(filter)
    ...
    return (
      ...
      <source src='underwater.mp4' type="video/mp4" />
                ...
                <img src="/truck.png" className='fixed top-0 w-screen h-screen  object-cover lg:hidden' alt="" />

                <img src="/airplane-bg.jpg" className='fixed top-0  w-screen h-screen  object-cover hidden md:block' alt="" />
